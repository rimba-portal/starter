...
<head>
    ...
    <style>
        ...
        .floating-box {
            ...
            /* POSITIONING: Change these values to position it anywhere on the screen */
            bottom: 40px;
            right: 40px;
        }
        ...
        @media (min-width: 768px) {
            ...
            /* NEW: Unhides the floating text box only when screen real estate permits */
            .floating-box { 
                display: block; 
            }
        }
...
<body>
    ...
    <div class="content-box">
        ...
        <p>Designed for modern manufacturing and enterprise teams, RIMBA brings everything organization needs into one unified platform — enabling clarity, efficiency, and smarter decisions at every level.</p>

        <div class="button-container">
            <a href="https://google.com" class="button-link">Go to Google</a>
            <a href="https://wikipedia.org" class="button-link">Go to Wikipedia</a>
        </div>
    </div>
